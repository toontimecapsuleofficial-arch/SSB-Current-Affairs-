...
const PopupFacts = (() => {
  const facts = [
    ...
    { icon: '🚀', text: 'The Agni-P (Prime) is a new generation nuclear-capable ballistic missile with a range between 1,000 and 2,000 km.' },
    { icon: '📡', text: 'The "Arudhra" is an indigenous Medium Power Radar (MPR) capable of detecting 4D targets.' },
    { icon: '🛳️', text: 'INS Anvesh is India’s first dedicated floating test range for tracking and launching interceptor missiles.' },
    { icon: '🚁', text: 'The "LUH" (Light Utility Helicopter) developed by HAL will replace the aging Cheetah and Chetak fleet.' },
    { icon: '🏰', text: 'The Kangra Fort is one of the oldest forts in India and survived a massive earthquake in 1905.' },
    { icon: '🏹', text: 'The "Pinaka-ER" (Extended Range) can now strike targets at a distance of over 70 kilometers.' },
    { icon: '🛰️', text: 'India’s "RISAT-2B" acts as a "spy eye" in the sky, using synthetic aperture radar to see through clouds.' },
    { icon: '🦁', text: 'The Ashoka Chakra in the Indian flag represents the "Wheel of Law" and has 24 spokes.' },
    { icon: '🚢', text: 'The "Sandhayak-class" are the largest survey vessels ever built indigenously in India.' },
    { icon: '🐆', text: 'The "Zorawar" is a lightweight tank specifically designed for high-altitude warfare in Ladakh.' },
    { icon: '🏔️', text: 'India built the world’s highest motorable pass at Umling La, surpassing the previous record held by Bolivia.' },
    { icon: '🚂', text: 'The "Vande Bharat Express" is India’s first indigenous semi-high-speed train set.' },
    { icon: '💂', text: 'The Gorkha Regiment is famous for the "Khukri," a traditional curved knife used in close combat.' },
    { icon: '🇮🇳', text: 'The Indian National Flag was designed by Pingali Venkayya, a freedom fighter from Andhra Pradesh.' },
    { icon: '🌉', text: 'The Pamban Bridge was India’s first sea bridge, connecting the mainland to Rameswaram.' },
    { icon: '🔭', text: 'The Devasthal Optical Telescope in Uttarakhand is the largest reflecting telescope in Asia.' },
    { icon: '🛡️', text: 'The "QRSAM" (Quick Reaction Surface-to-Air Missile) can be fired on the move to protect tank columns.' },
    { icon: '🌊', text: 'India is the only country after which an entire ocean (the Indian Ocean) is named.' },
    { icon: '🐅', text: 'The "Strike 1" Corps is one of the Indian Army’s primary offensive mountain strike formations.' },
    { icon: '📦', text: 'India is the second-largest mobile phone manufacturer in the world as of 2024.' },
    { icon: '💎', text: 'The Koh-i-Noor diamond, now part of the British Crown Jewels, was mined from the Kollur Mine in India.' },
    { icon: '🥊', text: 'The "Ghatak" Platoon is an elite infantry platoon in every Indian Army battalion specialized in raids.' },
    { icon: '🐚', text: 'The "Shankul" is an indigenous Shishumar-class submarine that underwent a major Life Certification project.' },
    { icon: '🌳', text: 'India has a "Tree Ambulance" service to provide botanical care and relocate uprooted trees.' },
    { icon: '🧬', text: 'India was the first country to develop a DNA-based COVID-19 vaccine (ZyCoV-D).' },
    { icon: '🚁', text: 'The IAF’s "Chinook" helicopters are used for heavy lifting and can carry artillery guns to mountain tops.' },
    { icon: '🎯', text: 'The "SAMAR" air defence system uses refurbished R-73 air-to-air missiles for ground-to-air roles.' },
    { icon: '🐘', text: 'The "Haathi" is a heavy-duty recovery vehicle used by the Indian Army for bogged-down tanks.' },
    { icon: '📉', text: 'India’s retail inflation is among the most stable compared to many G20 nations in recent years.' },
    { icon: '🏗️', text: 'The world’s highest railway pier bridge is being built in Noney, Manipur.' },
    { icon: '⚡', text: 'India’s "Agni-1P" uses a canister-based launch system, allowing for rapid deployment and mobility.' },
    { icon: '🦅', text: 'The "Trinetra" is an indigenously developed thermal imaging system for T-90 tanks.' },
    { icon: '🪖', text: 'The "Tavor TAR-21" is a standard-issue bullpup rifle for India’s Special Forces units.' },
    { icon: '🧱', text: 'The "Great Wall of India" at Kumbhalgarh Fort is the second-longest continuous wall in the world.' },
    { icon: '🌅', text: 'Kanyakumari is the only place in India where you can see the sun rise and set over the ocean.' },
    { icon: '🌊', text: 'The "Sagar Dhvani" is an oceanographic research vessel operated by the DRDO.' },
    { icon: '🚤', text: 'The "Fast Interceptor Craft" (FIC) used by the Sagar Prahari Bal can reach speeds of 45 knots.' },
    { icon: '🍲', text: 'India is the world’s largest producer of pulses, ginger, and okra.' },
    { icon: '🛰️', text: 'ISRO’s "Gaganyaan" mission aims to send Indian astronauts (Gaganauts) into space.' },
    { icon: '⚔️', text: 'The "Madras Regiment" is the oldest infantry regiment of the Indian Army, formed in 1758.' },
    { icon: '🔫', text: 'The "Prabal" is India’s first long-range revolver, designed for civilian and security use.' },
    { icon: '🛶', text: 'India’s first "Water Metro" was launched in Kochi, Kerala.' },
    { icon: '🪕', text: 'The "Veena" is one of the oldest string instruments, dating back to the Vedic period.' },
    { icon: '🐅', text: 'India has 54 Tiger Reserves, with the Guru Ghasidas National Park being one of the newest.' },
    { icon: '🚁', text: 'The "Dhruv" ALH (Advanced Light Helicopter) has a specialized variant for the Civil sector called "Garuda."' },
    { icon: '🐚', text: 'The "Varunastra" is an indigenous heavy-weight anti-submarine electric torpedo.' },
    { icon: '📡', text: 'The "Uttam" is an indigenous Active Electronically Scanned Array (AESA) radar for fighter jets.' },
    { icon: '⛰️', text: 'Kanchenjunga is the highest peak in India and the third-highest in the world.' },
    { icon: '💊', text: 'India is the largest provider of generic medicines globally, occupying a 20% share in global supply.' },
    { icon: '🕌', text: 'The Cheraman Juma Mosque in Kerala is the oldest mosque in India, built in 629 AD.' },
    { icon: '🦅', text: 'The "A-4I" is an indigenously developed Airborne Early Warning and Control (AEW&C) system.' },
    { icon: '🛩️', text: 'The "HJT-36 Sitara" is an indigenous Intermediate Jet Trainer (IJT) developed for the IAF.' },
    { icon: '🛳️', text: 'INS Imphal is the first capital warship to be named after a city in Northeast India.' },
    { icon: '🏗️', text: 'The "Marut" was India’s first indigenous fighter bomber, designed by Kurt Tank in the 1960s.' },
    { icon: '🚉', text: 'The Hubballi Railway Station in Karnataka has the world’s longest railway platform.' },
    { icon: '🧪', text: 'India’s "Sagarika" (K-15) was the first submarine-launched ballistic missile (SLBM) developed by DRDO.' },
    { icon: '🥊', text: 'The "Kshatriya" is a traditional dance-drama from Assam that was once part of military training.' },
    { icon: '🌞', text: 'The Modhera Sun Temple in Gujarat is the first village in India to run entirely on solar power.' },
    { icon: '🛡️', text: 'The "K-4" is an intermediate-range SLBM that completes India’s undersea nuclear deterrent.' },
    { icon: '🪖', text: 'The "Patrol" is an indigenous bulletproof vehicle used by the Indian paramilitary forces.' },
    { icon: '🪂', text: 'The "Akashganga" is the skydiving display team of the Indian Air Force.' },
    { icon: '🚢', text: 'The "Viraat" was the longest-serving aircraft carrier in the world before being decommissioned.' },
    { icon: '🐅', text: 'The "Maratha Light Infantry" was the first regiment to be designated as "Light Infantry."' },
    { icon: '🍵', text: 'The "Nilgiri Tea" from Tamil Nadu is famous worldwide for its intense aroma and flavor.' },
    { icon: '🏛️', text: 'The "Iron Pillar of Delhi" has stood for over 1,600 years without rusting due to ancient metallurgy.' },
    { icon: '🐆', text: 'The "Snow Leopard" is the state animal of Ladakh and Himachal Pradesh.' },
    { icon: '🚀', text: 'The "Pralay" is a short-range, surface-to-surface quasi-ballistic missile for battlefield use.' },
    { icon: '📡', text: 'The "Revathi" is a 3D surveillance radar used by the Indian Navy on its warships.' },
    { icon: '⛴️', text: 'The "Vikrant" aircraft carrier uses a STOBAR (Short Take-Off But Arrested Recovery) configuration.' },
    { icon: '🪖', text: 'The "F-INSAS" program aims to turn the Indian soldier into a fully networked combat system.' },
    { icon: '🐘', text: 'The "Gajraj" (IL-76) is a heavy-duty transport aircraft that has served the IAF for decades.' },
    { icon: '🕌', text: 'The "Bibi Ka Maqbara" in Aurangabad is known as the "Taj of the Deccan."' },
    { icon: '🎓', text: 'The Indian Institute of Science (IISc) in Bangalore is consistently ranked as India’s top research university.' },
    { icon: '🚜', text: 'India is the world’s largest manufacturer of tractors.' },
    { icon: '⚓', text: 'The "Tushil-class" frigates are being built as part of a deep partnership for advanced naval stealth.' },
    { icon: '🛩️', text: 'The "Hansa-NG" is the next-generation trainer aircraft designed by CSIR-NAL.' },
    { icon: '🏹', text: 'The "Arjun" tank uses a "Kanchan" composite armor that can withstand advanced anti-tank shells.' },
    { icon: '🎭', text: 'The "Kathakali" from Kerala is one of the oldest theater forms in the world.' },
    { icon: '🐚', text: 'India’s "Deep Ocean Mission" aims to explore the seafloor for rare minerals using "Matsya 6000."' },
    { icon: '🗺️', text: 'India shares its longest land border with Bangladesh (4,096 km).' },
    { icon: '⚔️', text: 'The "Sudarshan Chakra" Corps is the elite strike corps of the Indian Army’s Southern Command.' },
    { icon: '🛡️', text: 'The "Agni-V" features MIRV technology, allowing one missile to carry multiple warheads.' },
    { icon: '🪖', text: 'The "Nagastra-1" is India’s first indigenous loitering munition (suicide drone).' },
    { icon: '🚢', text: 'The "Vagshir" is the final submarine of the Kalvari-class (Scorpene) built at Mazagon Dock.' },
    { icon: '🦁', text: 'The "Lion Capital of Ashoka" at Sarnath was adopted as the State Emblem of India in 1950.' },
    { icon: '🏏', text: 'The Narendra Modi Stadium in Ahmedabad is the largest cricket stadium in the world.' },
    { icon: '🛰️', text: 'India’s "Astrosat" is the country’s first dedicated multi-wavelength space observatory.' },
    { icon: '🏗️', text: 'The "Bogibeel Bridge" in Assam is India’s longest rail-cum-road bridge.' },
    { icon: '🐆', text: 'The "Tejas Mk2" is an upcoming LCA variant with a more powerful engine and increased payload.' },
    { icon: '📡', text: 'The "Rohini" (3D-CAR) is a central acquisition radar used for the Akash missile system.' },
    { icon: '🐅', text: 'The "Grumman" (S-2) tracker was once used by the Indian Navy for anti-submarine warfare.' },
    { icon: '🪖', text: 'The "KP-MET" is an indigenously developed digital compass for Indian Army soldiers.' },
    { icon: '🌊', text: 'The "Lakshya" is a pilotless target aircraft used for training missile crews.' },
    { icon: '🚢', text: 'INS Kolkata was the first ship to be fitted with the advanced Barak-8 missile system.' },
    { icon: '🧥', text: 'The "Angora" wool produced in India is among the warmest and softest fibers globally.' },
    { icon: '🛕', text: 'The Shore Temple in Mahabalipuram is one of the oldest structural stone temples in South India.' },
    { icon: '🧬', text: 'The "Genome India Project" aims to sequence 10,000 Indian genomes to improve healthcare.' },
    { icon: '🪂', text: 'The "Shatrujeet" Brigade is the Indian Army’s elite rapid-response paratrooper formation.' },
    { icon: '🛶', text: 'India’s "Sagar Parikrama" was the first solo circumnavigation of the globe by an Indian (Capt. Dilip Donde).' },
    { icon: '🚩', text: 'The "Har Ghar Tiranga" campaign in 2022 saw over 200 million flags hoisted across India.' }
  ];
